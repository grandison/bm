...
class VkAccount < ActiveRecord::Base
  ...
  def self.update_sex(vk_ids)
    vk_ids.each_slice(100) do |ids_list|
      Oj.load(Typhoeus.post("https://api.vk.com/method/getProfiles?fields=city,sex&access_token=9a01834553da900ab575b7bd3a2c436289f6a7a1d8cb3255f8b4b79c598948b5dfe49ab93c4b0dbb8f5cc", body:{uids: ids_list.join(","), "Content-Type" => 'application/x-www-form-urlencoded'}).body)["response"].each do |account|
